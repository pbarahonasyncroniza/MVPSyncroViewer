 ...
 */
export declare class ToolComponent extends Component<Promise<Component<any>>> implements Disposable {
     ...
     */
    get<T, U extends Component<T>>(ToolClass: new (components: Components) => U): Promise<U>;
    /**
    ...
    getPlatformComponent<T, U extends Component<T>>(id: string): Promise<U>;
}
export {};
