...
export declare class Polygons {
    ...
    private _nextIndex;
    get items(): (THREE.Points<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | THREE.LineSegments<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]>)[];
